		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand" href="#">Productos</p>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" class="form-control"  placeholder="Marcador" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Marca</label>
                                                <input type="text" class="form-control" placeholder="big" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="td-actions">
                                                    ...
                                                    <button type="button" rel="tooltip" title="Dar baja" class="btn btn-danger btn-simple btn-xs">
