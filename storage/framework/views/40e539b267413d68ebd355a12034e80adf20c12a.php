            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cliente: <?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?></h4>
                                <hr>
                            </div>
                            <div class="content">
                                <form method="POST" action="<?php echo e(route('clientes.update', $cliente->id)); ?>" role="form">
...
<?php echo $__env->make('layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/clientes/edit.blade.php ENDPATH**/ ?>