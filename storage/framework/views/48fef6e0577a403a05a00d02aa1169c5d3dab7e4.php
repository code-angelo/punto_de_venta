...
<div class="wrapper">
                ...
                <div class="col-md-9">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-wrapper-scroll-y scroll-tabla-ventas content">
                                <form method="POST" action="<?php echo e(route('ventas.store')); ?>" role="form">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="cliente_id" class="form-control" id="client">
                                    ...
                                    <option value="<?php echo e($cliente->id); ?>"><?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?>
    ...
    <?php echo $__env->make('layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/ventas/index.blade.php ENDPATH**/ ?>